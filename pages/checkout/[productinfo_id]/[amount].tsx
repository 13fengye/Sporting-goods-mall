...
export async function getServerSideProps(context: { params: { productinfo_id: string, amount: number } }) {
  ...
  return {
    props: {
      product_no: context.params.productinfo_id,
                          ...
                          <div className="login-wrap">
                            <form action="#" method="post">
                              <div className="row">
                                ...
                                <div className="col-md-6">
                                  <div className="form-group mt-30">
                                    <button className="btn-login">注册</button>
                                    {/* <div className="rememberme-account">
                                      <div className="custom-control custom-checkbox">
                                        <input
                                          type="checkbox"
                        ...
                        >
                          ...
                          >
                            <div className="row">
                              ...
                              <div className="col-md-12">
                                <div className="form-group">
                                  <label htmlFor="street-address2-3">
                                    Street address{" "}
                                    <abbr className="required" title="required">
                                      *
                                    </abbr>
                ...
                <div className="checkout-order-details-wrap">
                  <div className="order-details-table-wrap table-responsive">
                    ...
                    <div className="shop-payment-method">
                        ...
                        <div className="card">
                          <div className="card-header" id="check_payments4">
                            ...
                            >
                              ...
                              <img
                                src="/static/picture/paypal2.webp"
                                width="40"
                                height="26"
                                alt="Image-HasTech"
                              />
                      ...
                      <a href="/account-login" className="btn-theme">
                        Place order
                      </a>
                    </div>
                  </div>
