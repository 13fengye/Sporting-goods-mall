                    ...
                    <div className="shop-top-bar">
                      <div className="shop-top-left">
                        <p className="pagination-line">
                          <a href="/">12</a> Product Found of <a href="/">30</a>
                        </p>
                      </div>
                              ...
                              <div className="inner-content">
                                <div className="product-thumb">
                                  ...
                                  <div className="product-action">
                                    ...
                                    <button
                                      type="button"
                                      className="btn-product-quick-view-open"
                                    >
                                      <i className="fa fa-arrows"></i>
                                    </button>
                                    <a
                                      className="btn-product-compare"
                                      href="/shop-compare"
                                    >
                            ...
                            <div className="product-item product-list-item">
                              <div className="inner-content">
                                <div className="product-thumb">
                                  <a href="/single-product">
                                    <img
                                      src="/static/picture/list-1.webp"
                                      width="322"
                                      height="360"
                                      alt="Image-HasTech"
                                    />
                                ...
                                <div className="product-info">
                                  ...
                                  <p>
                                    ...
                                    adipisicing elit. Voluptatem quo, rerum rem
                                    soluta quisquam, repellat is deleniti omnis
                                    culpa ea quis provident dolore esse, offici
                            ...
                            <div className="product-item product-list-item">
                              <div className="inner-content">
                                <div className="product-thumb">
                                  <a href="/single-product">
                                    <img
                                      src="/static/picture/list-2.webp"
                                      width="322"
                                      height="360"
                                      alt="Image-HasTech"
                                    />
                            ...
                            <div className="product-item product-list-item">
                              <div className="inner-content">
                                <div className="product-thumb">
                                  <a href="/single-product">
                                    <img
                                      src="/static/picture/list-3.webp"
                                      width="322"
                                      height="360"
                                      alt="Image-HasTech"
                                    />
                            ...
                            <div className="product-item product-list-item">
                              <div className="inner-content">
                                <div className="product-thumb">
                                  <a href="/single-product">
                                    <img
                                      src="/static/picture/list-4.webp"
                                      width="322"
                                      height="360"
                                      alt="Image-HasTech"
                                    />
                            ...
                            <div className="product-item product-list-item">
                              <div className="inner-content">
                                <div className="product-thumb">
                                  <a href="/single-product">
                                    <img
                                      src="/static/picture/list-5.webp"
                                      width="322"
                                      height="360"
                                      alt="Image-HasTech"
                                    />
                            ...
                            <div className="product-item product-list-item">
                              <div className="inner-content">
                                <div className="product-thumb">
                                  <a href="/single-product">
                                    <img
                                      src="/static/picture/list-6.webp"
                                      width="322"
                                      height="360"
                                      alt="Image-HasTech"
                                    />
