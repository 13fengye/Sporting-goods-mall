...
!(function (A, e, t) {
  ...
  function l(A, t, n, o) {
    ...
    return (
      ...
      (l = t(d, A)),
      f.fake
        ? (f.parentNode.removeChild(f), (B.style.overflow = s), B.offsetHeight)
  ...
  function u(A, e) {
    if ("object" == typeof A) for (var t in A) M(A, t) && u(t, A[t]);
    else {
      A = A.toLowerCase();
      var n = A.split("."),
        o = Modernizr[n[0]];
  ...
  function f(A, e, t) {
    ...
    for (var r in A)
      if (A[r] in e)
        return t === !1
          ? A[r]
          : ((o = e[A[r]]), n(o, "function") ? d(o, t || e) : o);
    return !1;
  }
  function h(A) {
  ...
  function p(e, n) {
    ...
    if ("CSS" in A && "supports" in A.CSS) {
      for (; o--; ) if (A.CSS.supports(h(e[o]), n)) return !0;
      return !1;
    }
  ...
  function g(A, e, o, r) {
    ...
    for (
      var u, d, f, h, m, g = ["modernizr", "tspan", "samp"];
      !S.style && g.length;
  ...
  T ||
    !(function (A, e) {
      ...
      function a(A, t, n) {
        ...
        return (
          (o = n.cache[A]
            ...
            : n.createElem(A)),
          !o.canHaveChildren || h.test(A) || o.tagUrn
            ? o
      ...
      function i(A, t) {
        ...
        t = t || r(A);
        for (
          var o = t.frag.cloneNode(), a = 0, i = n(), l = i.length;
          l > a;
          a++
        )
          o.createElement(i[a]);
