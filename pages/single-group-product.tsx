export default function SingleGroupProduct(){
  return (
    <>
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-6">
                      ...
                      <div className="product-single-info">
                        ...
                        <p>Lorem ipsum dolor sit amet, consecte adipisicing elit, sed do eiusmll tempor incididunt ut labore et dolore magna aliqua. Ut enim ad mill veniam, quis nostrud exercitation ullamco</p>
